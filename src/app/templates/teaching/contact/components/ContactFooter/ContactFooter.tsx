      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="flex items-center space-x-6">
            <a
              href="#"
              className="text-gray-500 hover:text-[#08AD98] transition-colors duration-200"
            >
              <svg
                width="24"
                height="24"
          ...
          <div className="text-center">
            <p className="text-sm text-gray-500 font-poppins">
              ©2024 Kodiyis | Powered by Kodiyis |
              <a
                href="#"
                className="hover:text-[#08AD98] transition-colors duration-200 ml-1"
              >
                Terms & Conditions
              </a>{" "}
              |
